...
import dev.lest.GymRecorder.core.usecases.Training.classes.DeleteTrainingCaseImp;
...
public class DeleteTrainingCaseImpTest {
    ...
    @InjectMocks
    private DeleteTrainingCaseImp trainingCaseImp;
