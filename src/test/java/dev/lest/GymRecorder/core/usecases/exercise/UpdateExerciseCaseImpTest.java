...
import dev.lest.GymRecorder.core.usecases.Exercise.classes.UpdateExerciseCaseImp;
...
public class UpdateExerciseCaseImpTest {

    @Mock
    private ExerciseGateway exerciseGateway;

    @InjectMocks
    private UpdateExerciseCaseImp exerciseCaseImp;
